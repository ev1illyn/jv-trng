	...
	public void init() {
		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				cursoDeViolao.adicionarCategorias(musica);
				...
				livroDeArquitetura.setLinkDaFoto("https://cdn.shopify.com/s/files/1/0155/7645/products/arquitetura-java-socialmedia_large.png?v=1411489903");
